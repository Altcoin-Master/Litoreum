...
rm -f src/config/litoreum-config.h
...
rm -rf test_bitcoin.coverage/ litoreum-gtest.coverage/ total.coverage/
...
clean_exe src/litoreum-cli
clean_exe src/litoreumd
clean_exe src/litoreum-gtest
clean_exe src/litoreum-tx
clean_exe src/test/test_litoreum
clean_exe src/test/test_litoreum_fuzzy
...
clean_dep . src/config/litoreum-config.h.in
