Contributing to Litoreum Core
============================

The Litoreum Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Altcoin-Master/litoreum/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Litoreum Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Litoreum
Network Protocol consensus changes.

Whether a pull request is merged into Litoreum Core rests with the project merge
...
Patches that change Litoreum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Litoreum consensus, it must have been
...
The review process is normally fairly responsive on the Litoreum Core repository, however
...
The project leader is the release manager for each Litoreum Core release.
