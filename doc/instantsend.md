...
This mechanism has been integrated into Bitcore-Node-Litoreum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Altcoin-Master/insight-api-litoreum#web-socket-api](https://github.com/Altcoin-Master/insight-api-litoreum#web-socket-api)
* API: [https://github.com/Altcoin-Master/insight-api-litoreum#instantsend-transactions](https://github.com/Altcoin-Master/insight-api-litoreum#instantsend-transactions)
