...
* litoreum.conf: contains configuration settings for litoreumd or litoreum-qt
* litoreumd.pid: stores the process id of litoreumd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by litoreumd or litoreum-qt
