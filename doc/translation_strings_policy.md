...
This document provides guidelines for internationalization of the Litoreum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `litoreum_en.ts` remains unchanged.
