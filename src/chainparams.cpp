...
{
    const char* pszTimestamp = "1/1/2023 Litoreum";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Litoreum: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Litoreum: 2 minutes
         ...
         */
        pchMessageStart[0] = 0x6c;//l
        pchMessageStart[1] = 0x74;//b
        pchMessageStart[2] = 0x72;//r
        pchMessageStart[3] = 0x6d;//m
        nDefaultPort = 21001;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1672502400, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1672502400, 2729, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe1d8c6c97a39c6af5216a86696b6498e21957fbeccd25d8bad8ec90457071800"));
        assert(genesis.hashMerkleRoot == uint256S("0xada2fd5b7ba01320563a4e99337e365dec2e369cca09be0541e9c227b274e95f"));

        vSeeds.emplace_back("seed01.litoreum.org");
        ...
        // Litoreum private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Litoreum BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Litoreum BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Litoreum BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"Le4Bf24bMRSzDaHFCWFrpk9Azri84miabi"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1672502400,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Litoreum: 1 day
        consensus.nPowTargetSpacing = 60; // Litoreum: 1 minutes
       ...
       // FindMainNetGenesisBlock(1645942755,  0x20001fff, "test");
        ...
        //vSeeds.emplace_back("ger1.litoreum.org", true);
        //vSeeds.emplace_back("ny1.litoreum.org", true);

        // Testnet Litoreum addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Litoreum script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Litoreum BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Litoreum BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Litoreum BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        chainTxData = ChainTxData{
            1672502400, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Litoreum: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Litoreum: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("litoreum.org",  "devnet-seed.litoreum.org"));

        // Testnet Litoreum addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Litoreum addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Litoreum script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Litoreum BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Litoreum BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Litoreum BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
