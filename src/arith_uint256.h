...
#ifndef LITOREUM_ARITH_UINT256_H
#define LITOREUM_ARITH_UINT256_H
...
public:
     ...
     *
     * Litoreum only uses this "compact" format for encoding difficulty
...
#endif // LITOREUM_ARITH_UINT256_H
