...
#error Client version information missing: version is not defined by litoreum-config.h or in any other way
#endif
...
/**
 * litoreumd-res.rc includes this file, but it cannot cope with real c++ code.
