...
//! Interface for the src/evo part of a litoreum node (litoreumd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a litoreum node (litoreumd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a litoreum node (litoreumd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a litoreum node (litoreumd process).
class Node
{
public:
    virtual ~Node() {}
