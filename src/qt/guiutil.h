...
/** Utility functions used by the Litoreum Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "litoreum:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load litoreum specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a litoreum specific theme is activated (light/dark).*/
