    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  litoreum-qt [command-line options]                     \n";
...
All the Litoreum in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 LTRM, 0.01 LTRM, 0.1 LTRM, 1 LTRM and 10 LTRM -- sort of like the paper money you use every day.</li> \
