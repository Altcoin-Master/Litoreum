...
from test_framework.test_framework import LitoreumTestFramework
...
class LLMQChainLocksTest(LitoreumTestFramework):
    def set_test_params(self):
        self.set_litoreum_test_params(6, 5, fast_dip3_enforcement=True)
