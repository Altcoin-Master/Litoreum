...
"""Verify that starting litoreumd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litoreumd with -h for help text")
        ...
        self.log.info("Start litoreumd with -version for version information")
